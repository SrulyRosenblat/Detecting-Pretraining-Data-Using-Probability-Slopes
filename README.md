...
## 1.  Introduction
Large Language Models are trained on a vast corpus of data, much of which is undisclosed. The aim of our research was an attempt to further reaserch on how to detect pretraining dataset in order to make LLM training more transparent to copyright holders and guard against data accsess violations.
